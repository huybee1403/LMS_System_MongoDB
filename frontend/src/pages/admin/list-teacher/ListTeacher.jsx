...
const ListTeacher = () => {
    ...
    const fetchAllUser = useCallback(async () => {
        try {
            ...
            setUsers(allUsers.filter((u) => u.user_type === "teacher"));
        } catch (e) {
            console.error(e);
        }
    }, []);
    ...
    return (
        <>
            <div className="layout-top">
                <h1 className="headline-1">Quản lý tài khoản giáo viên</h1>
                <button className="c-button-1" onClick={() => setIsCreateModalOpen(true)}>
                    <i className="fa-regular fa-square-plus" /> Thêm giáo viên
                </button>
            </div>
                    ...
                    <div className="modal_box">
                        ...
                        <Formik
                            ...
                            initialValues={{
                                ...
                                new_password: "",
                                role: users.find((u) => (u._id || u.id) === activeEditModalId)?.user_type || "teacher",
                            }}
                    ...
                    <div className="modal_box">
                        ...
                        <Formik
                            ...
                            onSubmit={(v, { resetForm }) =>
                                handleRegister({ ...v, user_type: "teacher" }, () => {
                                    resetForm();
                                    fetchAllUser();
